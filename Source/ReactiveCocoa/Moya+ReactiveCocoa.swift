...
public class ReactiveCocoaMoyaProvider<Target where Target: TargetType>: MoyaProvider<Target> {
    ...
    override func stubRequest(target: Target, request: NSURLRequest, completion: RxRxRxMoya.Completion, endpoint: Endpoint<Target>, stubBehavior: RxRxRxMoya.StubBehavior) -> CancellableToken {
